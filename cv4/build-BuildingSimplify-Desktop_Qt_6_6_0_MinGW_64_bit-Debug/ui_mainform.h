...
public:
    ...
    void setupUi(QMainWindow *MainForm)
    {
        ...
        actionMin_Area_Rectangle->setObjectName("actionMin_Area_Rectangle");
        QIcon icon2;
        ...
        actionWall_Average->setObjectName("actionWall_Average");
        QIcon icon3;
        ...
        actionLongest_Edge = new QAction(MainForm);
        actionLongest_Edge->setObjectName("actionLongest_Edge");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/icons/longestedge.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionLongest_Edge->setIcon(icon6);
        ...
        menuSimplify->addAction(actionLongest_Edge);
        ...
        toolBar->addAction(actionLongest_Edge);
        toolBar->addSeparator();
    ...
    void retranslateUi(QMainWindow *MainForm)
    {
        ...
        actionLongest_Edge->setText(QCoreApplication::translate("MainForm", "Longest Edge", nullptr));
#if QT_CONFIG(tooltip)
        actionLongest_Edge->setToolTip(QCoreApplication::translate("MainForm", "Create Longest Edge Approximation", nullptr));
#endif // QT_CONFIG(tooltip)
